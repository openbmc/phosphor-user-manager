...
void Users::delete_(void)
{
    ...
    if (enabledAdminList.first == 1)
    {
        if (userName == enabledAdminList.second[0])
        {
            // No delete user
...
std::string Users::userPrivilege(std::string value)
{
    ...
    if (enabledAdminList.first == 1)
    {
        if (userName == enabledAdminList.second[0] && value != "priv-admin")
        {
...
std::vector<std::string> Users::userGroups(std::vector<std::string> value)
{
    ...
    if (enabledAdminList.first == 1)
    {
        if (userName == enabledAdminList.second[0] && value.size() < 4)
        {
...
bool Users::userEnabled(bool value)
{
    ...
    if (enabledAdminList.first == 1)
    {
        if (userName == enabledAdminList.second[0] && value == false)
        {
