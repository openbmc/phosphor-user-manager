...
// TODO(nanzhou): when the interface change merged. Change this to
// GroupNameExists
...
void UserMgr::deleteGroups(std::vector<std::string> groupNames)
{
...
void UserMgr::deleteGroup(const std::string& groupName)
{
...
void UserMgr::createGroup(const std::string& groupName)
{
...
void UserMgr::createGroups(std::vector<std::string> groupNames)
{
