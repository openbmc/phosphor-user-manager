...
bool UserMgr::setPAMOrder(const std::vector<size_t> reqPamOrder)
{
    ...
    bool hasDuplicate =
        (std::unordered_set<size_t>(reqPamOrder.begin(), reqPamOrder.end())
    ...
    const std::vector<size_t> currentOrder = getPAMOrder();
...
std::vector<size_t> UserMgr::getPAMOrder()
{
