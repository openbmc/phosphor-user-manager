...
void executeCommand(const std::string& cmd, std::ofstream& outputFile)
{
...
DbusUserObj UserMgr::getPrivilegeMapperObject(const std::string& basePath)
{
    DbusUserObj objects;
    try
    {
...
UserInfoMap UserMgr::getUserInfo(std::string userName)
{
    ...
    else
    {
        ...
        DbusUserObj objects = getPrivilegeMapperObject(openLdapBasePath);
