...
struct UpdateFailure
{
    ...
    using REASON = _UpdateFailure::REASON;
    using metadata_types = std::tuple<ERRNO, REASON>;
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::User::Password::Error::UpdateFailure>
{
    using type = xyz::openbmc_project::User::Password::UpdateFailure;
};
