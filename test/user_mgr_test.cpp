...
class UserMgrInTest : public testing::Test, public UserMgr
{
  public:
    UserMgrInTest() : UserMgr(busInTest, objectRootInTest)
    {
        ...
        ON_CALL(*this, executeUserClearFailRecords).WillByDefault(testing::Return());
...
TEST_F(UserMgrInTest, DeleteUserThrowsInternalFailureWhenExecuteUserClearFailRecords)
{
