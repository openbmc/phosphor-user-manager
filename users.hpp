...
#include <xyz/openbmc_project/User/Users/server.hpp>

namespace phosphor {
namespace user {

namespace Base = sdbusplus::xyz::openbmc_project::User::server;
using UsersIface = sdbusplus::server::object::object<Base::Users>;

// Place where all user objects has to be created
constexpr auto USERS_OBJECT_PATH = "/xyz/openbmc_project/user/Users";
